...
<div class="actions wow fadeInDown text-center" data-wow-delay="0.6s"><a href="{{ route('ShareYourIdea') }}" class="btn-fill ">Get a free quote</a> <a onclick="$zopim.livechat.window.toggle()" style="cursor: pointer;" class="btn-line-fill ali-fill ">Want to Discuss </a></div>
