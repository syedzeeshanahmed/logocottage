<section class="section-padding progress-area wow">
  ...
  <div class="container">
   <div class="col-md-6">
      <section class="flags">
        ...
        <h3 class="text-left  wow fadeInDown" data-wow-delay="0.2">Global Clientele</h3>
        <p class="wow fadeInDown" data-wow-delay="0.4s">Where words don’t do justice to our portfolio, our clients do. We’ve established ourselves in several different countries and have worked with thousands of clients all over the world.</p>
        ...
        <div class="row marg-btm wow fadeInDown" data-wow-delay="0.2s">
          <div class="col-md-12">
            <br />
            <div class="flag"><img src="{{ asset('img/location.png') }}"></div>
          </div>
        </div>
  ...
  <div class="col-md-6">
      <section class="progress-bars">
        <h3 class="text-left wow fadeInDown" data-wow-delay="0.2s">We’re a Growth Focused <br>Design Agency</h3>
        <p class="bottom-space wow fadeInDown" data-wow-delay="0.4s">We love to discuss numbers that defines our performance to our clients and customers.</p>
        <div class="skill">
