              ...
              <form method="POST" action="{{ route('order.general.save') }}" id="quoteForm" autocomplete="off">
                ...
                <section data-view="2" style="display: none;">
                  <div class="tabs-form">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-20 field-mergedright">                    
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-20 field-mergedright">
                       ...
                       <input type="text" min="1" autocomplete="off" class="form-control" id="brand-date" placeholder="Would you like to schedule a call?" name="call" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Would you like to schedule a call?'" required="required" />
