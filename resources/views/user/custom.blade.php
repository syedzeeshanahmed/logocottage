          ...
          <div class="right-panel">
            <div class="row">
              <div class="col-md-5 main-hd">
                <h4 class="text-left title">Custom order</h4>
              </div>
              <div class="col-md-7">
              ...
              <section class="packages-tabs">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <ul class="tabs-profile clearfix">
                    <li class="tab-link current" data-tab="tab-1">Custom order</li>
                  </ul>
                    ...
                    <table id="listing" class="mdl-data-table display dash-data-table"  cellspacing="1" width="100%">
                      ...
                      <tfoot>
                        <tr>
                          <th><i class="fa fa-building" aria-hidden="true"></i> Reviews</th>
                          <th><i class="fa fa-list" aria-hidden="true"></i> Order Id</th>
                          <th><i class="fa fa-phone-square" aria-hidden="true"></i> Rating</th> </tr>
                      </tfoot>
                      <tbody>
                      ...
                      <tr>
                        ...
                        <td> @for( $i=0; $i
                          <$testimonial->
                          rating; $i++ ) <i class="fa fa-star" aria-hidden="true"></i> @endfor </td>
                      </tr>
                      @endforeach
                      @else
                      <tr>
