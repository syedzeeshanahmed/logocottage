          ...
          <div class="row">
            <div class="col-md-push-2 col-md-8">
              ...
              <section data-view="2" style="display: none;">
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12 margin-bottom-20 field-mergedright">
                    
                     <input type="text" min="1" autocomplete="off" class="form-control"  id="ecomm-date" placeholder="Would you like to schedule a call?" name="call" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Would you like to schedule a call?'" required="required" />
