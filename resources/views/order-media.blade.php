        ...
        <div class="container">
          <div class="row">
            <div class="col-md-push-2 col-md-8">
              ...
              <form method="POST" action="{{ route('order.social.save') }}" id="quoteForm" autocomplete="off">
              ...
              <div class="step-form">
                ...
                <section data-view="2" style="display: none;">
                  ...
                  <div class="col-md-12 col-xs-12 margin-bottom-20 field-mergedright">
                    <textarea class="form-control" name="outlets" placeholder="*Please name all marketing platforms?" onfocus="this.placeholder = ''" onblur="this.placeholder = '*Please name all marketing platforms?'" required="required"></textarea>
                    <p class="pull-left">Tell us what social media outlets you want to market at</p>
                  </div>
                  ...
                  <div class="col-md-12 col-xs-12 margin-bottom-20 field-mergedright order-call">
                    <input type="text" min="1" autocomplete="off" class="form-control" id="content-date" placeholder="Would you like to schedule a call?" name="call" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Would you like to schedule a call?'" required="required" />
                    <p class="pull-left">Let’s talk about your social media marketing plans</p>
                  </div>
