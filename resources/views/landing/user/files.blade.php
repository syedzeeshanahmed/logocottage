         ...
         <div class="col-md-12">
           <div class="right-panel">
            ...
            <div class="col-md-5 main-hd">
             <h4 class="text-left title">My Files</h4>
            </div>
            <div class="col-md-7">
              ...
              <section class="packages-tabs">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <ul class="tabs-profile clearfix">
                    <li class="tab-link current" data-tab="tab-1">Files</li>
                  </ul>
                  <div id="tab-1" class="tab-content current">
                    <table id="listing" class="mdl-data-table display table-responsive"  cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          <th><i class="fa fa-list" aria-hidden="true"></i> Handover No</th>
                          <th><i class="fa fa-list" aria-hidden="true"></i> File Name</th>
                          <th><i class="fa fa-calendar" aria-hidden="true"></i> Date provided</th>
                          <th><i class="fa fa-download" aria-hidden="true"></i> Download File</th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr>
                      ...
                      @if($files != null)
                        @foreach($files as $file)
                          <tr>
                            <td> handover - {{ $file->handover_id }} </td>
                            <td> {{ $file->path }} </td>
                            <td> {{ date('l jS \of F Y',  strtotime($file->created_at) ) }} </td> <!-- l jS \of F Y h:i:s A -->
                            <td><a href="{{ route('dash.file.download', $file->path) }}"><i class="fa fa-download" aria-hidden="true"></i> Download</a></td>
                          </tr>
                        @endforeach
                      @else
                        <tr>
