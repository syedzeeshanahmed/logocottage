...
@section('body')
  ...
  @if( isset( $herovideo ) )
    @include( 'landing.include.' . $herovideo )  
  @else
    ...
    <section class="breakdown">
      <div class="row">
        ...
        <div class="col-md-5 col-sm-5 col-lg-5 col-xs-12 height-for-quote">
          <div class="d_t"> @include('landing.include.service-quote', ['interest'=> $headings[0]  ]) </div>
        </div>
      </div>
    </section>
  </div>
...
<div class="subservice-packages section-padding"> 
  ...
  @include( 'landing.include.packages-logo-marketing' , ['servicesPage' => 1] )  


  <div class="services_process_section"> @if( isset( $oldImgs ) )
    @include('landing.include.subservice-process', [ 'content' => $process, 'headings'=> $processHeadings, 'oldImgs' => $oldImgs ] )</div>
  @else
  @include('landing.include.subservice-process', [ 'content' => $process, 'headings'=> $processHeadings ] )</div>
@endif
</div>
...
@if( isset( $portfolio ) )
  @include( 'landing.include.' . $portfolio )  
@else
  @include('landing.include.portfolio-logo-marketing')
@endif 
</div>

<div class="boder-space"> @include('landing.include.qualities')</div>
@include('landing.include.subscribe_fold')
@include('landing.include.count')

@include('landing.include.testimonials')



@include('landing.include.quote')


@include('landing.include.portfoliomodal')
...
.header-content .call-action span small { color: #fff; }
