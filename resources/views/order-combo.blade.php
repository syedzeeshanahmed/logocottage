...
<section class="getQuote order-web">
  <div class="d_t">
    <div class="d_c">
      <div class="text-center logo"><a href="{{ route('order.general.save') }}"><img src="{{ asset('img/logo-inside.png') }}"></a></div>
            ...
            <div class="col-md-push-2 col-md-8">
              ...
              <div class="step-form">
                <section data-view="1">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 margin-bottom-20 field-mergedright">
                    <input type="text" min="1" autocomplete="off" class="form-control" placeholder="Business Name" name="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Business Name'" required="required" />
                  </div>
              ...
              <section data-view="2" style="display: none;">  
                <div class="tabs-form">
                  ...
                  <div class="ccol-md-6 col-sm-6 col-xs-12 margin-bottom-20 field-mergedleft">
                  ...
                  <div class="col-md-12 col-xs-12 margin-bottom-20 clearfix">
                    <textarea class="form-control" name="description" placeholder="*Web Description" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Web Description'" required="required"></textarea>
                    <p class="pull-left">Please describe the state of your website i.e. informational website, company website, magazine blog etc</p>
                  </div>
                  
                  
                  <div class="col-md-12 col-xs-12 margin-bottom-20 clearfix">
                    <textarea class="form-control" name="description" placeholder="*Targeted Audience" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Targeted Audience'" required="required"></textarea>
                    <p class="pull-left">Please tell us briefly about the audience you’re targeting</p>
                  </div>
                  <div class="col-md-12 col-xs-12 margin-bottom-20 clearfix">
                    <textarea class="form-control" name="description" placeholder="*Web Pages" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Web Pages'" required="required"></textarea>
                    <p class="pull-left">Please provide the list of webpages you need as per the navigation separated by a comma (homepage, contact us page, blog page etc.)
</p>
                  </div>
