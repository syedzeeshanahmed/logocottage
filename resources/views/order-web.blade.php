        ...
        <div class="container">
          <div class="row">
            <div class="col-md-push-2 col-md-8">
              ...
              <form method="POST" action="{{ route('order.web.save') }}" id="quoteForm" autocomplete="off">
                ...
                <section data-view="1">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 margin-bottom-20 field-mergedright">
                    <input type="text" min="1" autocomplete="off" class="form-control" placeholder="Business Name" name="business_name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Business Name'" required="required" />
                  </div>
              ...
              <section data-view="2" style="display: none;">
                  ...
                  <div class="col-md-12 col-xs-12 margin-bottom-20 clearfix">
                    <textarea class="form-control" name="state" placeholder="*Web Description" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Web Description'" required="required"></textarea>
                  ...
                  <div class="col-md-12 col-xs-12 margin-bottom-20 clearfix">
                    <textarea class="form-control" name="audience" placeholder="*Targeted Audience" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Targeted Audience'" required="required"></textarea>
                    <p class="pull-left">Please tell us briefly about the audience you’re targeting</p>
                  </div>
                  <div class="col-md-12 col-xs-12 margin-bottom-20 clearfix">
                    <textarea class="form-control" name="navigation" placeholder="*Web Pages" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Web Pages'" required="required"></textarea>
